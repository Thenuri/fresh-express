    ...
    <div>
                              ...
                              <form action="#" method="GET" class="lg:hidden">
                                ...
                                <li>
                                    <a href="{{ route('products') }}"
                                        class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                        <svg class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75"
                                            fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="14"
                                        ...
                                        <svg class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75"
                                            ...
                                            <g fill="none" stroke="currentColor" stroke-width="1.5">
                                                ...
                                                <path fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    d="M15.5 16a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Zm-7-7a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1Z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" d="m16 8l-8 8" />
                                            </g>
                                        </svg>
                                        <span class="ml-3 flex-1 whitespace-nowrap">Promotions</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('deliverdorders') }}"
                                        ...
                                        <span class="ml-3 flex-1 whitespace-nowrap">Deliverd Orders</span>
                                    </a>
                                </li>
                                {{-- <li>
        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('do_notification', () => ({
                    nonDispatchedOrders: {{ $non_dispatched_orders }},
                    init() {
                        ...
                        var pusher = new Pusher('3ecb80c9c6f49fc0e9f8', {
                            cluster: 'ap1'
                        });

                        var channel = pusher.subscribe('fresh-express-orders');
                        channel.bind('new-order-received', function(data) {
                            self.nonDispatchedOrders = data.order_count;
                        });
                    }
                }))
            })
